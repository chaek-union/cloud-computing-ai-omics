...
- 처음 읽는 경우에는 Chapter 1부터 Chapter 4까지 순서대로 읽으며 클라우드와 오믹스 데이터의 기본 사고방식을 익힌다.
- 리눅스와 생물정보학 파이프라인에 익숙하다면 Chapter 5부터 실전 운영 파트로 넘어가도 된다.
- single-cell과 spatial omics에 관심이 있다면 Chapter 13을 중심으로, AI 활용 흐름에 관심이 있다면 Chapter 12, 14, 18을 연달아 읽으면 좋다.
