# Chapter 19. 산업계 사례와 데이터 브로커로 배우는 AWS 오믹스 운영
...
## 19.2 Takeda, ImmunoScape, Goldfinch로 보는 scale-out 패턴
...
## 19.3 Seven Bridges, Basepair, Research Gateway로 보는 data broker 패턴
...
## 19.4 AWS Marketplace와 private offer로 조달하는 유전체 AI 플랫폼
...
## 19.5 공개 데이터 민주화와 hybrid cloud의 공존
